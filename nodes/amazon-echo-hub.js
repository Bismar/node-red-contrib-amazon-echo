module.exports = function(RED) {
  ...
  function api(app, hubNode, config) {
    ...
    var apiTemplateDir = __dirname + '/resources/api/hue/templates';
    ...
    app.get('/description.xml', function(req, res) {
      var template = fs.readFileSync(apiTemplateDir + '/description.xml').toString();
    ...
    app.post('/api', function(req, res) {
      var template = fs.readFileSync(apiTemplateDir + '/registration.json', 'utf8').toString();
    ...
    app.get('/api/:username/lights', function(req, res) {
      var template = fs.readFileSync(apiTemplateDir + '/lights/all.json', 'utf8').toString();
    ...
    app.get('/api/:username/lights/:id', function(req, res) {
      var template = fs.readFileSync(apiTemplateDir + '/lights/get-state.json', 'utf8').toString();
    ...
    app.put('/api/:username/lights/:id/state', function(req, res) {
      ...
      var template = fs.readFileSync(apiTemplateDir + '/lights/set-state.json', 'utf8').toString();
